            ...
            var result = (
                           ...
                           select new
                           {
                               ...
                               cell = new string[]
                                                     {
                                                         det.Id,
                                                         det.ActionId != null ? det.ActionId.Id : null,
...
EnumCommissionPeople.Therapist.ToString(),
GetCommissionEmployeeName(det,EnumCommissionPeople.Therapist)   ,
                                     EnumCommissionPeople.Medician.ToString(),
                                     GetCommissionEmployeeName(det,EnumCommissionPeople.Medician)   
                                                     }
                           });
