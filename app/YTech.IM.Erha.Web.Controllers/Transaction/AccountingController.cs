...
namespace YTech.IM.GSP.Web.Controllers.Transaction
{
    ...
    public class AccountingController : Controller
    {
        ...
        {
            if (formCollection["SubmitButtonValue"] == "btnSave")
            {
                ...
                if (formCollection["SubmitButtonValue"] == "btnPrint" || formCollection["SubmitButtonValue"] == "btnPrintKwitansi")
                {
                    //save data to session
                    SetDataForPrint(journal.Id);
                    string reportUrl = string.Empty;
                    if (formCollection["SubmitButtonValue"] == "btnPrint")
                    {
                        reportUrl = Url.Content("~/ReportViewer.aspx?rpt=RptPrintCash");
                    }
                    else if (formCollection["SubmitButtonValue"] == "btnPrintKwitansi")
                    {
     ...
     ;
        ...
        {
            OpeningViewModel viewModel = OpeningViewModel.CreateOpeningViewModel(_tRecPeriodRepository, _tJournalRepository);
