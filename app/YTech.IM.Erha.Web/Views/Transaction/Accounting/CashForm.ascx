...
<div class="ui-state-highlight ui-corner-all" style="padding: 5pt; margin-bottom: 5pt; display: none;"
    id="error">
    <p>
...
<div id="formArea">
    ...
    <%=Html.Hidden("SubmitButtonValue", "")%>
    <div>
        <span id="toolbar" class="ui-widget-header ui-corner-all"><a id="newJournal" href="<%= Url.Action(ViewData.Model.Journal.JournalType, "Accounting") %>">Baru</a>
            <%=Html.Button("btnSave","Simpan",HtmlButtonType.Submit,"ChangeSubmitButtonValue('btnSave');",new {@class = "button k-button"}) %>
            <%=Html.Button("btnPrint","Cetak Bukti",HtmlButtonType.Submit,"ChangeSubmitButtonValue('btnPrint');",new {@class = "button k-button"}) %>
            <%=Html.Button("btnPrintKwitansi","Cetak Kwitansi",HtmlButtonType.Submit,"ChangeSubmitButtonValue('btnPrintKwitansi');",new {@class = "button k-button"}) %>
            <button id="btnList" name="btnList" type="button" class="button" value="list">
                Edit
                <%= ViewData.Model.Title %></button>
            <%-- <button id="btnSave" name="btnSave" type="submit" class="button k-button" value="save">
                Simpan</button>
            <button id="btnPrint" name="btnPrint" type="submit" class="button k-button" value="printBukti">
                Cetak Bukti</button>
            <button id="btnPrintKwitansi" name="btnPrintKwitansi" type="submit" class="button k-button" value="printKwintansi">
...
<script language="javascript" type="text/javascript">
    function ChangeSubmitButtonValue(submitValue) {
        //alert("submitValue = " + submitValue);
        $("#SubmitButtonValue").val(submitValue);
        //alert("submitValue = " + $("#SubmitButtonValue").val());
    }
