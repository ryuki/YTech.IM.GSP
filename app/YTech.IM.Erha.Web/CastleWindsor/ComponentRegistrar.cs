...
namespace YTech.IM.GSP.Web.CastleWindsor
{
    public class ComponentRegistrar
    {
        ...
        private static void AddApplicationServicesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                .FromAssemblyNamed("YTech.IM.GSP.ApplicationServices")
                .Pick()
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                .FromAssemblyNamed("YTech.IM.GSP.Data")
                .Pick()
                .WithService.FirstNonGenericCoreInterface("YTech.IM.GSP.Core"));
        }
